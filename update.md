...
- ECS prefers GitHub's first-party `codeload.github.com` archive endpoint because it is more reliable on the current network route; this is still the same public repository and does not introduce a third-party mirror.
